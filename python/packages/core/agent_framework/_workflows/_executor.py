...
def _validate_handler_signature(
    ...
    *,
    ...
    # Resolve postponed annotations (from __future__ import annotations) to real typing objects.
    # This is required for WorkflowContext[...] validation and message type extraction.
    ...
    try:
        ...
        # Fall back to raw inspect.signature annotations.
        type_hints = {}
