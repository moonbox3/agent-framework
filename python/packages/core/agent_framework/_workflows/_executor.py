...
def _validate_handler_signature(
    ...
    *,
    ...
    # Resolve annotations for "from __future__ import annotations" (stringified annotations)
    # so validate_workflow_context_annotation can use typing.get_origin/get_args.
