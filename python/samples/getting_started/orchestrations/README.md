...
| Handoff with Azure AI Agent                       | [handoff_participant_factory_azure_ai_agent.py](./handoff_participant_factory_azure_ai_agent.py) | Handoff workflow with tool approvals and checkpoint resume using AzureAIProjectAgentProvider         |
