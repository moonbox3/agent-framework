...
| Magentic + Human Input (HITL) | [orchestration/magentic_human_in_the_loop.py](./orchestration/magentic_human_in_the_loop.py) | Plan review plus human input during agent execution |
