...
| Group Chat with ChatOptions | [orchestration/group_chat_with_chat_options.py](./orchestration/group_chat_with_chat_options.py) | Configure LLM parameters for prompt-based manager using ChatOptions |
