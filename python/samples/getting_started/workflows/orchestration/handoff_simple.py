...
def _handle_events(events: list[WorkflowEvent]) -> list[WorkflowEvent[HandoffAgentUserRequest]]:
    ...
    for event in events:
        # Data event with AgentResponse: Contains messages generated by agents during their turn
        ...
        # Output event: Contains the final conversation when workflow terminates
